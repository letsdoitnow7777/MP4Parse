...
{
    return underlyingStream->readBigEndianUnsignedShort();
}

uint16_t BinaryStreamBounded::readLittleEndianUnsignedShort()
{
    return underlyingStream->readLittleEndianUnsignedShort();
}


uint32_t BinaryStreamBounded::readBigEndianUnsignedInteger()
{
    return underlyingStream->readBigEndianUnsignedInteger();
}

uint32_t BinaryStreamBounded::readLittleEndianUnsignedInteger()
{
    return underlyingStream->readLittleEndianUnsignedInteger();
}
...
{
    return underlyingStream->readBigEndianFixedPoint(integerLength, fractionalLength);
}

std::string * BinaryStreamBounded::readBigEndianISO639Code()
{
    return underlyingStream->readBigEndianISO639Code();
}
